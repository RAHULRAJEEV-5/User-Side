    ...
    <section class=" bg-grey">
        <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mt-8 space-x-6">
                ...
                <a href="https://www.instagram.com/shalom_a_abraham/" class="text-white hover:text-gray-500">
                ...
                <a href="https://github.com/ShalomAbyAbraham" class="text-white hover:text-gray-500">
